...
export default function Recent() {
        ...
        const [shoppingCardAll, setshoppingCardAll] = useState([
            {
                img: card_1,
                img2: card_1H,
                category: 'Furniture',
        ...
        const [shoppingCardFurniture, setshoppingCardFurniture] = useState([
            {
                img: card_8,
                img2: card_8H,
        ...
        const [shoppingCardDecoration, setshoppingCardDecoration] = useState([
            {
                img: card_6,
                img2: card_6H,
                category: 'Decoration,Electronics,Lighting',
        ...
        const [shoppingCardLighting,setShoppingCardLighting] = useState([
            {
                img: card_6,
                img2: card_6H,
                category: 'Decoration,Electronics,Lighting',
    ...
    <div>
        ...
        <Switch>
            <Route exact path='/'>
                <div className={styles.lunchboxWrapper , styles.lunchboxWrapper1}>
                    <div className={styles.lunchbox, styles.lunchbox1}>
                                <div className={styles.cardWrapper}>
                                    {
                                    shoppingCardAll.map((item)=>(
                                            
                                            <ShoppingCard item={item} className={styles.ShopCard}/>
